...
from deye_grid_charge import DeyeGridChargeControlEventProcessor
...
class DeyeProcessorFactory:
    ...
    def __create_builtin_processors(
        ...
        self.__append_processor(
            processors, DeyeGridChargeControlEventProcessor(logger_config, self.__mqtt_client, sensors, modbus)
        )
        return processors
